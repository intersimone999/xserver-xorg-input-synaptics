...
makedepends=('xorg-server-devel' 'X-ABI-XINPUT_VERSION=21.1' 'libxi' 'libx11' 'resourceproto' 'scrnsaverproto' 'git')
conflicts=('xorg-server<1.15.0' 'X-ABI-XINPUT_VERSION<21.1' 'X-ABI-XINPUT_VERSION>=22')
...
source=("${pkgname}::git+https://github.com/intersimone999/xserver-xorg-input-synaptics.git")
#        add_tapbuttons.diff)
sha256sums=('SKIP')
